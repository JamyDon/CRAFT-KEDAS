...
def apply_memit_to_model(
    ...
    **kwargs
    ...
    for i, request in enumerate(requests):
        deltas = execute_memit(model, tok, [request], hparams, cache_template=cache_template)
        ...
        print(f"New weights successfully inserted into {list(deltas.keys())} for request {i}")
