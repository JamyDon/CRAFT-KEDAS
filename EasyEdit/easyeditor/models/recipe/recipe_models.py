import torch
from transformers import AutoTokenizer, BertModel, RobertaModel, RobertaTokenizer
from torch import nn
from typing import List, Dict


class KnowledgeRepModel(nn.Module):
    """Knowledge Representation Model for RECIPE"""
    ...
    def compute_reps(self, lhs, po, attention_mask, knowl_or_query):
        """Compute knowledge/query representations"""
        ...
        if knowl_or_query == 'k':
            ...
            raise ValueError("knowl_or_query must be 'k' or 'q'")
        
        return x  # [n, rep_n]

    def forward(self, edit_sentences: List[str], knowl_or_query: str):
        """Forward pass for knowledge representation"""
    ...
    def get_knowl_rep_prot(self):
        """Get knowledge representation prototype"""
...
class PromptTransformer(nn.Module):
    """Prompt Transformer for generating editing prompts"""
    ...
    def forward(self, knowledge_reps: torch.Tensor):
        """Generate prompts from knowledge representations"""
