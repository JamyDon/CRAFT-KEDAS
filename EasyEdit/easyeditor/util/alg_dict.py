...
from ..models.kedas import KEDASHyperParams, apply_kedas_to_model
from ..models.lte import LTEHyperParams, apply_lte_to_model
...
from ..models.eren import ERENHyperParams, apply_eren_to_model
from ..models.recipe import RECIPEHyperParams, apply_recipe_to_model
...
ALG_DICT = {
    ...
    'KEDAS': apply_KEDAS_to_model,
    'LTE': apply_lte_to_model,
    ...
    'EREN': apply_eren_to_model,
    'RECIPE': apply_recipe_to_model
}
