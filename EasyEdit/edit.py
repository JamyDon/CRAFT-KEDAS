...
def my_test_MEND_Meta_Train():
    training_hparams = MENDTrainingHparams.from_hparams('./hparams/TRAINING/MEND/llama2-7b.yaml')
...
def my_test_MEND_Meta_Train_Qwen():
    training_hparams = MENDTrainingHparams.from_hparams('./hparams/TRAINING/MEND/qwen2.5-7b.yaml')
    train_ds = ZsreDataset('../data/ZsRE/zsre_mend_train_10000.json', config=training_hparams)
    eval_ds = ZsreDataset('../data/ZsRE/zsre_mend_eval.json', config=training_hparams)
    trainer = EditTrainer(
        config=training_hparams,
...
def my_test_SERAC_Zsre_Train():
    training_hparams = SERACTrainingHparams.from_hparams('./hparams/TRAINING/SERAC/llama2-7b.yaml')
    train_ds = ZsreDataset('../data/ZsRE/zsre_mend_train_10000.json', config=training_hparams)
    eval_ds = ZsreDataset('../data/ZsRE/zsre_mend_eval.json', config=training_hparams)
    trainer = EditTrainer(
        config=training_hparams,
...
def my_test_SERAC_Zsre_Train_Qwen():
    training_hparams = SERACTrainingHparams.from_hparams('./hparams/TRAINING/SERAC/qwen2.5-7b.yaml')
    train_ds = ZsreDataset('../data/ZsRE/zsre_mend_train_10000.json', config=training_hparams)
    eval_ds = ZsreDataset('../data/ZsRE/zsre_mend_eval.json', config=training_hparams)
    trainer = EditTrainer(
        config=training_hparams,
...
def main():
    ...
    # test_MEMIT()
    # test_EMMET()
    # my_test_MEND_Meta_Train()
    # test_MEND_Meta_Train()
    # test_MEND()
    # test_KE()
    # test_SERAC_Counterfacat_Train()
    # test_SERAC_Zsre_Train()
    # my_test_SERAC_Zsre_Train()
    # my_test_SERAC_Zsre_Train_Qwen()
    my_test_MEND_Meta_Train_Qwen()
    # test_SERAC()
    # test_IKE()
    # test_IKE_2()
    # test_IKE_Llama()
